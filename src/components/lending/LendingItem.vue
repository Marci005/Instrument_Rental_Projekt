  ...
  <div class="card h-100">
    <div class="card-body d-flex flex-column">
      ...
      <div class="lending-meta small text-muted mb-3">
        <div class="mb-1">{{ formattedStart }} → {{ formattedEnd }}</div>
        <div v-if="durationDays" class="mb-1">{{ durationDays }} nap</div>
        <div v-if="lending.instrument?.monthly_price">{{ formattedMonthlyPrice }}</div>
      </div>
